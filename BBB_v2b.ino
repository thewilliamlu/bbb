...
Itegrating a IR sensor to the board for extra functionality
****************************************************************/
...
void moveForward() { //declare forward movement function
  ...
  LMS = speedSet + leftFactor + LeftMotorSpeed + motorAcceleration;
  RMS = speedSet + rightFactor + RightMotorSpeed + motorAcceleration;
}
...
void turnLeft() { //declare left turn function
  ...
  LMS = -(speedSet + leftFactor);
  RMS = (speedSet + rightFactor);
}
